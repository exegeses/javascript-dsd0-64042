...
//asignamos contenido inicial al párrafo 'txt'
txt.innerText = espanol;

let eleccion = prompt('Elija un idioma - (Español, Francés, Inglés)');
if( eleccion == 'Español'|| eleccion == 'español' ){
    txt.innerText = espanol;
}
else if( eleccion == 'Francés'|| eleccion == 'francés' ){
    txt.innerText = frances;
}
else if( eleccion == 'Inglés'|| eleccion == 'inglés' ){
    txt.innerText = ingles;
}